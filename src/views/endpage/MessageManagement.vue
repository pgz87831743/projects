<template>
  <div>
    ...
    <el-row>
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="createByFromUser.username" label="留言人"/>
        <el-table-column prop="createByToUser.username" label="接收人"/>
  ...
  <el-dialog v-model="dialog.dialogFormVisible" :title="dialog.optionName" @closed="dialogClose">
    <el-form :model="form" label-position="right" label-width="150px" :disabled="dialog.formDisabled">
      <el-form-item label="留言内容"><el-input v-model="form.content"/></el-form-item>
      <el-form-item label="留言人"><el-input v-model="form.createByFrom"/></el-form-item>
      <el-form-item label="接收人"><el-input v-model="form.createByTo"/></el-form-item>
    </el-form>
    <template #footer>
  ...
  methods: {
    clickButton(type, row) {
      if (type === 'add') {
        ...
        this.$http.delete(`/yw/message-management/deleteById/${row.id}`)
            .then(() => {
              this.initTableData()
            })
      }
    ...
    formSubmit() {
      ...
      if (this.dialog.isAdd) {
        ...
        this.$http.post('/yw/message-management/update', this.form)
            .then(() => {
              this.initTableData();
            })
      }
