    ...
    <el-row>
      <el-table :data="tableData" border style="width: 100%;" :header-cell-style="{textAlign:'center'}"
        ...
        <el-table-column label="操作" width="300px">
          <template #default="scope">
            <el-button size="small" type="primary" @click="clickButton('update', scope.row)">审核</el-button>
...
import {
  ...
  loanDeleteById, loanFinancialReview,
  loanGetById,
  loanPage,
