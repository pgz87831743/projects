...
<el-table-column prop="targetId" label="会话ID"/>
<el-table-column prop="toUser" label="接收人"/>
...
<el-input v-model="form.targetId" placeholder="请输入"/>
</el-form-item>
<el-form-item label="接收人">
<el-input v-model="form.toUser" placeholder="请输入"/>
</el-form-item>
</el-form>
<template #footer>
...
import {messageApi} from "@/api/api";
        ...
        messageApi.getById(row.id).then((resp) => {
        this.dialog.dialogFormVisible = true
        ...
        messageApi.deleteById(row.id).then(() => {
        this.initTableData()
        })
        }
        },
        ...
        messageApi.page(this.page).then(resp => {
        this.tableData = resp.data.data.records
        this.total = resp.data.data.total
        })
        },
