  ...
  <div class="p-div">
    <el-row>
            <el-col :span="5" :offset="1">
              <el-input v-model="page.search" placeholder="请输入交易内容" clearable @clear="this.initTableData"/>
            </el-col>
...
export default {
  ...
  methods: {
    ...
    search() {
      transactionApi.treasurerPage(this.page)
          .then(resp => {
    ...
    currentChange(number) {
      ...
      transactionApi.treasurerPage(this.page).then(resp => {
        this.tableData = resp.data.data.records
        this.total = resp.data.data.total
      })
    },
